		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="graph_metrics.html">
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="<%=path %>/employee/listPage.do">在职员工管理</a>
						</li>
						<li><a class="J_menuItem" href="<%=path %>/history/retireListPage.do">离休员工管理</a>
						</li>
				...
				<li><a href="mailbox.html">
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="<%=path %>/wage/WageList.do">工资查询</a>
						</li>
						<li><a class="J_menuItem" href="<%=path %>/employee/addwagelist.do">工资计算</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="<%=path %>/contract/contractList.do">合同查询</a>
						</li>
					</ul>
				</li>
				<li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
