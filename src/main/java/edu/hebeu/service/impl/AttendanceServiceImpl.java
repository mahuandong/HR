...
public class AttendanceServiceImpl extends ServiceImpl<AttendanceMapper, Attendance> 
	...
	public List<Attendance> selectList() {
		//查询所有的考勤记录，根据id倒序排序
		return this.attendanceMapper.selectAll();
	}
	...
	public int Late(Attendance record) {
		return this.attendanceMapper.Late(record);
	}

	public int Overtime(Attendance record) {
		return this.attendanceMapper.Overtime(record);
	}
}